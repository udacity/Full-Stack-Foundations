...
menuItem2 = MenuItem(
    ...
    minced meat and finely chopped vegetables wrapped into a piece of dough \
    skin. The skin can be either thin and elastic or thicker.""",
    price="$6.99",
    course="Appetizer",
    restaurant=restaurant1)
...
menuItem3 = MenuItem(
    ...
    noticeable in the Chinese version, the light seasoning of Japanese gyoza \
    with salt and soy sauce, and the fact that gyoza wrappers are much \
    thinner""",
    price="$9.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem4 = MenuItem(
    ...
    garlic sauce cooked with fresh cilantro, celery, chilies,ginger & green \
    onions",
    price="$6.95",
    course="Appetizer",
    restaurant=restaurant1)
...
menuItem5 = MenuItem(
    ...
    curry sauce, potatoes (aloo), fried cauliflower (gobi) and chutney. Nom \
    Nom""",
    price="$7.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem1 = MenuItem(
    ...
    description=(
        "Marinated Pork, Rice, Beans, Avocado, Cilantro, Salsa, Tortilla"),
    price="$5.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem2 = MenuItem(
    ...
    stuffed with queso telita or queso de mano, and possibly lechon.""",
    price="$7.99",
    course="Entree",
    restaurant=restaurant1)
